    ...
    <div class="row ">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div id="divHeaderPanel">
                ...
                <asp:Button ID="btnAddRole" CssClass="btn btn-info btn-sm btnResize btnAddCustom" CausesValidation="False" runat="server" Text="Add User" OnClick="btnAddRole_Click" />
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <asp:DetailsView
                            ...
                            OnItemInserting="dtlRoleInfo_ItemInserting"
                            OnItemInserted="dtlRoleInfo_ItemInserted"
                            OnItemUpdating="dtlRoleInfo_ItemUpdating"
                            OnItemUpdated="dtlRoleInfo_ItemUpdated"
                            DataSourceID="dtsRoleInfoDtl"
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField HeaderText="Confirm Passowrd" SortExpression="password">
                                    <EditItemTemplate>
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="reqConfirmPassword" runat="server" ControlToValidate="txtConfirmPassword" ErrorMessage="Required!" Display="Dynamic" CssClass="crStyle"></asp:RequiredFieldValidator>
                                        <asp:CompareValidator ID="cmpPassword" runat="server"  ControlToValidate="txtConfirmPassword" ErrorMessage="Password do not matched!" SetFocusOnError="True" CssClass="crStyle"></asp:CompareValidator>--%>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" Text=""></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator ID="reqConfirmPassword" runat="server" ControlToValidate="txtConfirmPassword" ErrorMessage="Required!" Display="Dynamic" CssClass="crStyle"></asp:RequiredFieldValidator>
                                        <asp:CompareValidator ID="cmpPassword" runat="server" ControlToCompare="txtConfirmPassword" ControlToValidate="txtConfirmPassword" ErrorMessage="Password do not matched!" SetFocusOnError="True" CssClass="crStyle"></asp:CompareValidator>--%>
                                    </InsertItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Access Page" SortExpression="accessPage" ItemStyle-CssClass="chkDesign" ControlStyle-Width="330px ">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <EditItemTemplate>
                                        <asp:LinkButton ID="lnkBtnUpdate" runat="server" CausesValidation="True" CssClass="btn btn-default btn-sm btnSizeF" CommandName="Update" Text="Save"></asp:LinkButton>
                ...
                <div class="modal-footer" runat="server" id="modalFooter">
                    <button type="submit" class="btn btn-lg btnCustomize" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <div class="gridHeader">
                ...
                <div class="col-md-8 col-sm-8 col-xs-8 gridTitle text-right form-inline">
                    <div class="form-group float-left">
                        <asp:TextBox ID="txtSearch" CssClass="search form-control" placeholder="Search..." runat="server" AutoPostBack="true" OnTextChanged="txtSearchByID_TextChanged"></asp:TextBox>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdRoleInfo"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Id" SortExpression="roleID">
                        <EditItemTemplate>
                            <asp:Label ID="lblRoleID" runat="server" Text='<%# Bind("roleID") %>'></asp:Label>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Type" SortExpression="branchType">
                        <ItemTemplate>
                            <asp:Label ID="lblBranchType" runat="server" Text='<%# Eval("branchType").ToString() %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Access Page" SortExpression="title" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblAccessPage" runat="server" Text='<%# Bind("accessPage") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Archive" ShowHeader="False">
                        <ItemTemplate>
            ...
            <asp:SqlDataSource ID="dtsRoleInfoGrd" runat="server" ConnectionString="<%$ ConnectionStrings:dbPOS %>"
                DeleteCommand="DELETE FROM [RoleInfo] WHERE [roleID] = '0'"
                ProviderName="<%$ ConnectionStrings:dbPOS.ProviderName %>"
