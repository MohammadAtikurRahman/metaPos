    ...
    <div class="analytic-reprot dashboard">
                ...
                <div class="card">
                    <div class="content-summary">
                        <div class="row">
                            ...
                            <div class="col-xs-10">
                                <div class="numbers">
                                    <p class="sale-amount">Today Sale</p>
                        ...
                        <div class="footer-summary">
                            <hr>
                            <div class="stats">
                                <i class="fa fa-refresh update-status"> Updated</i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="content-summary">
                        <div class="row">
                            ...
                            <div class="col-xs-10">
                                <div class="numbers">
                                    <p class="new-invice">New Invoice</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="section">
                    <h3 class="title last-four-month-sale">Last 4 month Sales</h3>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="section">
                    <h3 class="title last-month-popular-product">This month popular product <span runat="server" id="lblProductDate"></span></h3>
