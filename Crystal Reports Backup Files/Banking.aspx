...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="section">
                <h2 class="sectionBreadcrumb lang-accounting-banking">Banking</h2>
    ...
    <div class="row headerDesign">
        ...
        <asp:Panel ID="pnlCashOut" runat="server" DefaultButton="btnCashOutAdd">
            <div class="col-md-4 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField BankingField section">
                    <h2 class="sectionHeading lang-accounting-add-bank-withdraw">Add Bank Withdraw</h2>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label1" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-bank-name" runat="server" Text="Bank Name"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group" id="divCashOutDescriptions" runat="server" visible="true">
                        <asp:Label ID="lblCashOutMainDescr" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-description" runat="server" Text="Description"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                            <asp:TextBox ID="txtCashOutMainDescr" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lblCashOutAmount" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-amount" runat="server" Text="Amount"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group" id="div1" runat="server" visible="true">
                        <asp:Label ID="Label3" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-withdraw-date" runat="server" Text="Withdraw Date"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
        ...
        <asp:Panel ID="pnlCashIn" runat="server" DefaultButton="btnCashInAdd">
            <div class="col-md-4 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField BankingField section">
                    <h2 class="sectionHeading lang-accounting-add-bank-diposit">Add Bank Deposit</h2>
                    <div class="form-group" runat="server" visible="false">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblBankName" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-bank-name" runat="server" Text="Bank Name"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblCashInMainDescr" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-description" runat="server" Text="Description"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                            <asp:TextBox ID="txtCashInMainDescr" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lblCashInAmount" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-amount" runat="server" Text="Amount"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group" id="div2" runat="server" visible="true">
                        <asp:Label ID="Label4" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-diposit-date" runat="server" Text="Diposit Date"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField BankingField section">
                    ...
                    <div class="form-group" id="divStoreList" runat="server">
                        <asp:Label ID="Label5" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-store" runat="server" Text="Store"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group"  runat="server" id="divUserList">
                        <asp:Label ID="Label9" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-user" runat="server" Text="User"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblCashSearchType" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-particular" runat="server" Text="Particular"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-bank-name" runat="server" Text="Bank Name"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateFrom" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-from" runat="server" Text="From"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateTo" CssClass="lbl col-sm-4 col-xs-5 control-label lang-accounting-to" runat="server" Text="To"></asp:Label>
                        <div class="col-sm-8 col-xs-7">
    ...
    <div class="row gridTopButton">
        <div class="btn-group btnGroupDesignLeft" role="group">
            <asp:Button ID="btnAddBank" CssClass="btn btn-info btnAddCustom btnAddOpt" runat="server" Text="Add Bank" OnClick="btnAddBank_Click" />
        </div>
        ...
        <div class="col-md-12">
            <div class="gridHeader">
                <div class="col-md-4 col-sm-4 col-xs-3 gridTitle text-left">
                    <label class="lang-accounting-banking-report">Banking Report</label>
                </div>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdCashReportInfo" OnRowDataBound="grdCashReportInfo_RowDataBound" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Details" SortExpression="mainDescr" ItemStyle-Width="25%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Cash In" SortExpression="cashIn">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Cash Out" SortExpression="cashOut">
                        <ItemTemplate>
