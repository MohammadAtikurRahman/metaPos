    ...
    <div class="add-package">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
                <div class="section">
                    <h3 class="sectionBreadcrumb lang-inventory-package">Package</h3>
                    ...
                    <div class="section3 set-height">
                        ...
                        <asp:Panel ID="pnlScan" runat="server" DefaultButton="btnLoadProductDetails">
                            <div class="input-group add-product">
                                <asp:TextBox ID="txtSearchNameCode" CssClass="form-control" runat="server" aria-describedby="btnLoadProductDetails" placeholder="Search/Scan to add Product by Name/Code"></asp:TextBox>
                        ...
                        <div class="staticContentUnit mainItem">
                            <span class="lang-inventory-sl">SL</span>
                            <span class="lang-inventory-product-title">Product Title</span>
                            <span class="disNone">Qty</span>
                            <span class="lang-inventory-price">Price</span>
                        </div>
                    ...
                    <asp:Panel ID="Panel2" runat="server" DefaultButton="btnUpdate">
                        <div class="section3">
                            <div class="form-horizontal salePadding">
                                <h4 class="lang-inventory-add-update-package">Add/Update Package</h4>
                                <hr />
                                <asp:Label ID="lblPackageId" runat="server" Visible="false"></asp:Label>
                                <div class="form-group">
                                    <asp:Label ID="lblPackageName" CssClass="lbl col-sm-4 control-label lang-inventory-package-name" runat="server" Text="Package Name"></asp:Label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label3" CssClass="lbl col-sm-4 control-label lang-inventory-wholesale-price" runat="server" Text="Wholesale Price"></asp:Label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="lblPrice" CssClass="lbl col-sm-4 control-label lang-inventory-sale-price" runat="server" Text="Sale Price"></asp:Label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group padding-bottom-75">
                                    <div class="col-sm-12">
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" ValidationGroup="Save" CssClass="btn btn-info btn-md btnUpdateCustom  pull-right btnEditOpt" OnClick="btnUpdate_Click" />
                                        <asp:Button ID="btnPackageSave" runat="server" Text="Save" ValidationGroup="Save" CssClass="btn btn-success btn-md btnAddCustom btnAddOpt pull-right" OnClick="btnPackageSave_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="gridHeader">
                    <div class="col-md-4 col-xs-4 gridTitle text-left">
                        <label class="lang-inventory-package-list">Package List</label>
                    </div>
                ...
                <div class="scroll">
                    <asp:GridView ID="grdPackage" runat="server" CssClass="mGrid gBox scrollBar" AutoGenerateColumns="False" EmptyDataText="No data records found." AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Qty (Min)" ItemStyle-Width="15%">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text="" ID="lblminQty"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Empty Qty" ItemStyle-Width="15%" SortExpression="emptyQty">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Delete" ShowHeader="False" ItemStyle-Width="10%">
                                <ItemTemplate>
