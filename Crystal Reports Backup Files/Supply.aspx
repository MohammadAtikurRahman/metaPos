...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div id="divHeaderPanel">
                <label class="title lang-accounting-supply">Supplier Payment</label>
                <asp:Button ID="btnAddSupplier" CssClass="btn btn-info btn-sm btnResize btnAddCustom btn-supply-add-supply" runat="server" Text="Add Supplier" OnClick="btnAddSupplier_Click" />
            </div>
        </div>
    </div>
    ...
    <div class="row headerDesign">
        ...
        <asp:Panel ID="pnlCashIn" runat="server" DefaultButton="btnCashInAdd">
            <div class="col-md-4 col-sm-6 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    <h2 class="sectionHeading lang-accounting-opening-balance">Opening Balance</h2>
                    ...
                    <div class="form-group" id="div1" runat="server">
                        <asp:Label ID="Label2" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-supplier" runat="server" Text="Supplier"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group" id="div2" runat="server">
                        <asp:Label ID="Label3" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-description" runat="server" Text="Description"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                            <asp:TextBox ID="txtCashInMainDescr" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label4" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-amount" runat="server" Text="Amount"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label5" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-date" runat="server" Text="Date"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group padding-bottom-70">
                        <asp:Button ID="btnCashInAdd" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnAddCustom btnAddOpt" runat="server" ValidationGroup="cashIn" Text="Add" OnClick="btnCashInAdd_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
        <asp:Panel ID="pnlCashOut" runat="server" DefaultButton="btnCashOutAdd">
            <div class="col-md-4 col-sm-6 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    <h2 class="sectionHeading lang-supply-give-payment">Give Payment</h2>
                    <div class="form-group disNone">
                    ...
                    <div class="form-group" id="divCashOutTypeSup" runat="server">
                        <asp:Label ID="lblCashOutTypeSup" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-supplier" runat="server" Text="Supplier"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group" id="divCashOutDescriptions" runat="server">
                        <asp:Label ID="lblCashOutMainDescr" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-description" runat="server" Text="Description"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                            <asp:TextBox ID="txtCashOutMainDescr" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lblCashOutAmount" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-amount" runat="server" Text="Amount"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label7" CssClass="lbl col-sm-4 col-xs-4 control-label lang-supply-date" runat="server" Text="Date"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group padding-bottom-70">
                        <asp:Button ID="btnCashOutAdd" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnAddCustom btnAddOpt" runat="server" ValidationGroup="cashOut" Text="Add" OnClick="btnCashOutAdd_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    ...
                    <div class="form-group"  runat="server" id="divStoreList">
                        <asp:Label ID="Label8" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-store" runat="server" Text="Store"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group"  runat="server" id="divUserList">
                        <asp:Label ID="Label9" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-user" runat="server" Text="User"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group" id="divSearchSup" runat="server">
                        <asp:Label ID="lblSearchSup" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-by-supplier" runat="server" Text="By Supplier"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateFrom" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-date-from" runat="server" Text="Date From"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateTo" CssClass="lbl col-sm-4 col-xs-4 control-label lang-accounting-date-to" runat="server" Text="Date To"></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                    ...
                    <div class="">
                        ...
                        <div class="col-sm-8 col-xs-8">
                            <asp:CheckBox runat="server" ID="chkAnyDate" AutoPostBack="True" Text="Any Date" CssClass="lang-accounting-any-date checkbox" />
                        </div>
                    </div>
                    <div class="">
                        <asp:Label runat="server" CssClass="lbl col-sm-4 col-xs-4 control-label" Text=""></asp:Label>
                        <div class="col-sm-8 col-xs-8">
                            <asp:CheckBox runat="server" ID="chkSchedule" AutoPostBack="True" Text="Schedule" CssClass="checkbox" />
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="gridHeader">
                <div class="col-xs-4 gridTitle text-left">
                    <label class="lang-supply-supply-reprot">Supply Report</label>
                </div>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdCashReportInfo" OnRowDataBound="grdCashReportInfo_RowDataBound" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="P. Code" SortExpression="purchaseCode">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="P. Amount" SortExpression="cashIn">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Payment" SortExpression="cashOut" ItemStyle-Width="10%">
                        <ItemTemplate>
                        ...
                        <div class="openingDuePay ">
                            <div class="form-inline">
                                <div class="form-group col-md-12">
                                    ...
                                    <asp:Button ID="btnShedulePay" runat="server" Text="Pay Now" CssClass="btn btn-primary btnDeleteOpt" OnClick="btnShedulePay_OnClick" />
                                </div>
                            </div>
                        </div>
                    </div>
