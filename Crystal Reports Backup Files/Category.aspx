    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div id="divHeaderPanel">
                <label class="title lang-record-category">Category</label>
                <a id="btnSaveModal" class="btn btn-info btn-sm btnResize btnAddCustom subbranch-hide lang-record-add-category" data-toggle="modal" data-backdrop="static">Add Category</a>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div id="divSearchPanel">
                <div class="col-md-4 col-sm-4 col-xs-4 gridTitle text-left">
                    <label class="lang-record-category-list">Category List</label>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group group-section">
                                <label class="col-md-4 lang-record-category-name">Category Name</label>
                                <div class="col-md-8">
