...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
        ...
        <div id="divHeaderPanel" class="margin-top-10">
            <label class="title lang-sales-servicing">Servicing</label>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-customer">Customer</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty disNone">
                        <label class="col-md-4 lang-servicing-id">Servicing Id</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-product-name">Product Name</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-imei">IMEI</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-description">Description</label>
                        <div class="col-md-8">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-supplier">Supplier</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-delivery-date">Delivery Date</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-total-amount">Total Amount </label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group padding-top-thirty">
                        <label class="col-md-4 lang-servicing-pay-cost">Pay Cost</label>
                        <div class="col-md-8">
                    ...
                    <div class="padding-top-thirty">
                        <div class="pull-right padding-right-15">
                            <input id="btnResetService" type="button" class="btn btn-default" value="Reset" />
                            <input id="btnSaveService" type="button" class="btn btn-primary" value="Save" />
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="gridHeader">
                    <div class="col-md-6 col-sm-4 col-xs-4 gridTitle two-line-grid-title text-left">
                        <label class="lang-servicing-servicing-report">Servicing Report</label>
                    </div>
                    <div class="col-md-6 col-sm-8 col-xs-8 gridTitle form-inline">
                        <asp:Panel ID="PanelSearchStock" runat="server">
                            <div class="form-group stock-search-field float-left">
                                <asp:TextBox ID="txtFrom" CssClass="form-control datepickerCSS" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_OnTextChanged" placeholder="Date Form"></asp:TextBox>
                            </div>
                            <div class="form-group stock-search-field float-left margin-left-7">
                                <asp:TextBox ID="txtTo" CssClass="form-control datepickerCSS" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_OnTextChanged" placeholder="Date To"></asp:TextBox>
                            </div>
                            <div class="form-group stock-search-field float-left">
                                <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_OnTextChanged" placeholder="Search..."></asp:TextBox>
                            </div>
                        </asp:Panel>
                    </div>
                </div>
            ...
            <div class="scroll">
                <div class="col-md-12">
                    <asp:GridView ID="grdServiceing" runat="server" AutoGenerateColumns="false" DataKeyNames="serviceId"
                        PageSize="5" OnPageIndexChanging="grdServiceing_OnPageIndexChanging" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ServicingID" SortExpression="serviceId">
                                <EditItemTemplate>
                            ...
                            <asp:BoundField DataField="cusName" HeaderText="Cus Name" SortExpression="cusName"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="supplier" HeaderText="Supplier" SortExpression="supplier" Visible="false"></asp:BoundField>
                            <asp:BoundField DataField="entryDate" HeaderText="Received" SortExpression="entryDate" DataFormatString="{0:d-MMMM-yyyy}" ItemStyle-Width="15%"></asp:BoundField>
                            <asp:BoundField DataField="deliveryDate" HeaderText="Delivery" SortExpression="deliveryDate" DataFormatString="{0:d-MMMM-yyyy}"></asp:BoundField>
                            <asp:BoundField DataField="description" HeaderText="Description" SortExpression="description" Visible="false"></asp:BoundField>
                            <asp:TemplateField HeaderText="Total" SortExpression="totalAmt">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Paid" SortExpression="paidAmt">
                                <EditItemTemplate>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel">
                                <b class="lang-servicing-servicing-Id">Servicing ID: </b>
                                <asp:Label ID="lblServceId" runat="server"></asp:Label></h3>
                        </div>
                        <div class="modal-body">
                            <asp:DetailsView ID="dltServiceView" runat="server" CssClass="mGrid gBox gCus mDtl dtlSize" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="dsServiceDetailsView">
                                <Fields>
                                    ...
                                    <asp:BoundField DataField="serviceId" HeaderText="Servicing ID" SortExpression="serviceId"></asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="paidAmt" HeaderText="Paid Amount" SortExpression="paidAmt"></asp:BoundField>
                                    <asp:BoundField DataField="totalAmt" HeaderText="Total Amount" SortExpression="totalAmt"></asp:BoundField>
                                    <asp:BoundField DataField="entryDate" HeaderText="Received Date" SortExpression="entryDate" DataFormatString="{0:d-MMMM-yyyy}"></asp:BoundField>
                                    <asp:BoundField DataField="deliveryDate" HeaderText="Delivery Date" SortExpression="deliveryDate" DataFormatString="{0:d-MMMM-yyyy}"></asp:BoundField>
                                    <asp:BoundField DataField="updateDate" HeaderText="updateDate" SortExpression="updateDate" Visible="false"></asp:BoundField>
                                    <asp:BoundField DataField="roleID" HeaderText="roleID" SortExpression="roleID" Visible="false"></asp:BoundField>
                                    <asp:BoundField DataField="active" HeaderText="active" SortExpression="active" Visible="false"></asp:BoundField>
                                </Fields>
                            </asp:DetailsView>
                            <asp:SqlDataSource runat="server" ID="dsServiceDetailsView" ConnectionString='<%$ ConnectionStrings:dbPOS %>' SelectCommand="SELECT * FROM [ServicingInfo] WHERE ([serviceId] = @serviceId)">
                                <SelectParameters>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:Button runat="server" CssClass="btn btn-primary" Text="Change Status" ID="btnStatusChage" OnClick="btnStatusChage_OnClick" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:Button runat="server" CssClass="btn btn-primary" Text="Pay now" ID="btnServicePay" OnClick="btnServicePay_OnClick" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<%= ResolveUrl("~/Js/select2.min.js?v=0.030") %>"></script>
