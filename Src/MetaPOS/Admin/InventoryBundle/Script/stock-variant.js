...
$(document).ready(function () {
    ...
    function changeVariant() {
        ...
        $('#varientArea').html("");
        $('#contentBody_hiddenAttributeJosnValue').html("");
        $('#contentBody_hiddenFieldJosnValue').html("");
        $('#contentBody_hiddenAttributeJosnValue').val("");
        $('#contentBody_hiddenFieldJosnValue').val("");
    ...
    function ResetType() {
        console.log("Reset....");
        $('#contentBody_ddlProductType option:selected').val("0")
    }
