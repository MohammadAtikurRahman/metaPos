...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="<%= ResolveUrl("~/Admin/InventoryBundle/Content/Expiry.css?v=0.003") %>" />
    <link rel="stylesheet" href="<%= ResolveUrl("~/Admin/InventoryBundle/Content/Expiry-responsive.css?v=0.002") %>" />
    ...
    <div class="warningQty">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
                <div class="section">
                    <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_expiry %></h2>
            ...
            <div class="col-md-12">
                <div class="">
                    <div class="col-md-12 col-sm-12 col-xs-12 gridTitle text-left">
                        <label><%=Resources.Language.Lbl_expiry_expired_product_history %></label>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 gridTitle text-right form-inline">
                        <div class="form-group float-left margin-left-7">
                            <asp:CheckBox runat="server" ID="chkListExpiry" Text="<%$Resources:Language, Lbl_expiry_all_preview %>" CssClass="expiry-preview-all" AutoPostBack="true" OnCheckedChanged="chkListExpiry_CheckedChanged"/>
                        </div>
                        <div class="form-group float-left margin-left-7">
                            ...
                            <span><%=Resources.Language.Lbl_expiry_to %></span>
                        <div class="form-group float-left margin-left-7">
                        ...
                        <div class="form-group stock-search-field float-left margin-left-7">
                            <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_action" placeholder="<%$Resources:Language, Lbl_expiry_search %>"></asp:TextBox>
                        </div>
            ...
            <div class="col-md-12">
                <div class="scroll">
                    <asp:GridView ID="grdExpiryQty" runat="server" AutoGenerateColumns="False" CssClass="mGrid gBox scrollBar" PageSize="10"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expiry_sl %>" ControlStyle-Width="5%">
                                <ItemTemplate>
                                    <%#Container.DataItemIndex + 1 %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" Visible="false"></asp:BoundField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expiry_product_name %>" SortExpression="prodName">
                                <EditItemTemplate>
                            ...
                            <asp:BoundField DataField="catName" HeaderText="<%$Resources:Language, Lbl_expiry_category_name %>" SortExpression="catName" ItemStyle-Width="25%"></asp:BoundField>
                            <asp:BoundField DataField="qty" HeaderText="<%$Resources:Language, Lbl_expiry_current_qty %>" SortExpression="qty" ItemStyle-Width="15%"></asp:BoundField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expiry_expiry %>" SortExpression="expiryDate">
                                <ItemTemplate>
