...
namespace MetaPOS.Admin.InventoryBundle.View
{
    ...
    public partial class StockBulkOpt : BasePage
    {
        ...
        private DataSet dsLoadField;//ds,
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (whichPage == "unit")
                {
                    ...
                    btnAddToPurchaseCart.Text = Resources.Language.Btn_purchase_save;
                    lblStockTitle.Text = Resources.Language.Title_purchase_product;
                ...
                if (commonFunction.findSettingItemValueDataTable("businessType") == "electronics")
                {
                    Label1.Text = Resources.Language.Lbl_purchase_product_model;
                }
                else
                {
                    Label1.Text = Resources.Language.Lbl_purchase_product_name;
                }
                ...
                commonFunction.fillAllDdl(ddlStoreList, "SELECT name,Id FROM [WarehouseInfo] WHERE active='1' AND name !='' " + Session["userAccessParameters"] + " ORDER BY name ASC", "name",
                    "Id");

                if (commonFunction.findSettingItemValueDataTable("displayLocation") == "1")
                {
                    divLocation.Visible = true;
                    string query = "SELECT name,Id FROM [LocationInfo] WHERE active='1' " + Session["userAccessParameters"] + " ORDER BY name ASC";
                    commonFunction.fillAllDdl(ddlLocationList, query, "name",
                        "Id");

                    var sqlOperation = new SqlOperation();
                    var dtLocation = sqlOperation.getDataTable(query);
                    if (dtLocation.Rows.Count == 1)
                        ddlLocationList.SelectedValue = dtLocation.Rows[0][1].ToString();
                }
                ddlLocationList.Items.Insert(0, new ListItem(Resources.Language.Lbl_purchase_select, "0"));
                ...
                else if (dtSelectedStore.Rows.Count > 0)
                    ddlStoreList.SelectedValue = dtSelectedStore.Rows[0]["storeId"].ToString();
                ...
                ddlManufacturer.Items.Insert(0, new ListItem(Resources.Language.Lbl_purchase_select, "0"));
                ddlSup.Items.Insert(0, new ListItem(Resources.Language.Lbl_purchase_select, "0"));
                ddlCat.Items.Insert(0, new ListItem(Resources.Language.Lbl_purchase_select, "0"));
        ...
        protected void btnLoadProductDetails_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var dtStock = commonFunction.LoadProductDetail(prouctId, ddlStoreList.SelectedValue);
            ...
            if (dtStock.Rows.Count > 0)
            {
                ...
                else
                {
                    foreach (DataRow row in dtStock.Rows)
                    {
                        ...
                        btnAddToPurchaseCart.Text = Resources.Language.Btn_purchase_update;
                        ...
                        // Qty Sepearate   
                        lblCurrentQty.Text = row["stockQty"].ToString();  //commonFunction.getStockQtyByUnitMeasurement(prodCodeValue, storeId);
        ...
        protected void AddToPurchaseCart(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isProductUpdate)
                {
                    ...
                    else
                    {
                        ...
                        dicProductListUpdate.Add("warehouse" + stockCounter, ddlStoreList.SelectedValue);
                ...
                else
                {
                    ...
                    dicProductListCreate.Add("warehouse" + stockCounter, ddlStoreList.SelectedValue);
                ...
                if (whichPage == "unit")
                    SaveProductCartToDatabase(null, null);
            }
            catch (Exception ex)
            {
        ...
        private bool checkReuiredValidation()
        {
            ...
            if (btnAddToPurchaseCart.Text == "Add")
            {
                var dsCheckBulkStock = objSql.getDataSet("SELECT * FROM StockInfo WHERE prodCode ='" + txtScanCode.Text + "' " +
                                      HttpContext.Current.Session["userAccessParameters"] + " AND warehouse = '" + ddlStoreList.SelectedValue + "'");
                ...
                var dsSku =
                    objSql.getDataSet("SELECT * FROM StockInfo WHERE sku ='" + txtSku.Text + "' " + HttpContext.Current.Session["userAccessParameters"] + " AND warehouse = '" + ddlStoreList.SelectedValue + "'");
            ...
            string queryProdCode = "SELECT * FROM StockInfo WHERE prodCode ='" + txtScanCode.Text + "' " + HttpContext.Current.Session["userAccessParameters"] + " AND warehouse = '" + ddlStoreList.SelectedValue + "'";
        ...
        private bool checkInputValidation()
        {
            ...
            if (commonFunction.findSettingItemValueDataTable("isWarehouse") == "1" && ddlStoreList.SelectedValue == "0")
            {
        ...
        protected void SaveProductCartToDatabase(object sender, EventArgs e)
        {
            var confirmSaved = "";
            ...
            DateTime purchaseDateTime = commonFunction.GetCurrentTime();
            try
            {
                purchaseDateTime = Convert.ToDateTime(purchaseDate);
            }
            catch (Exception)
            {
                purchaseDateTime = commonFunction.GetCurrentTime();
            }
            ...
            try
            {
                ...
                for (k = 0; k < stockCounter; k++)
                {
                    if (commdStatus[k] == "update")
                    {
                        ...
                        confirmSaved = updatetStockInfoFromDic(purchaseCode, purchaseDateTime);


                    }
                    else if (commdStatus[k] == "insert")
                    {
                        confirmSaved = saveStockInfoFomDic(purchaseCode, purchaseDateTime, k);
        ...
        private void updateSupplierCommission(string purchaseCode, int exten)
        {
            ...
            if (dbSupCommission != inputSupCommission)
            {
                ...
                // Update buy price 
                var dbQty = commonFunction.getLastStockQty(productId, ddlStoreList.SelectedValue);
        ...
        private string saveStockInfoFomDic(string purchaseCode, DateTime purchaseDate, int sCounter)
        {
            int rowTest = 0;
            var productName = "";
            try
            {
                ...
                if (dicProductListCreate.ContainsValue(insert))
                {
                    ...
                    stockModel.storeId = Convert.ToInt32(dicProductListCreate["warehouse" + sCounter]);
                    ...
                    stockModel.entryDate = Convert.ToDateTime(purchaseDate);
        ...
        private string updatetStockInfoFromDic(string purchaseCode, DateTime purchaseDate)
        {
            try
            {
                ...
                if (dicProductListUpdate.ContainsValue(update))
                {
                    ...
                    stockModel.catName = dicProductListUpdate["catName" + k];
                    stockModel.searchType = "product";
                    stockModel.branchId = Session["branchId"].ToString();
                    stockModel.groupId = Session["groupId"].ToString();
                    stockModel.entryDate = purchaseDate;
                    stockModel.updateDate = commonFunction.GetCurrentTime();
                    ...
                    var dtQtyManagement = stockModel.getStockQtyManagement();
                    if (dtQtyManagement.Rows.Count > 0)
                    {
                        QtyManagement qtyManagement = new QtyManagement();
                        qtyManagement.ProductId = prodId;
                        qtyManagement.StoreId = dicProductListUpdate["warehouse" + k];
                        qtyManagement.operationalQty = qtyStockUpdate;
                        var currentQty = qtyManagement.addStockQty();

                        stockModel.qty = currentQty;
                        stockModel.updateStockQty();
                    }
                    else
                    {
                        stockModel.createStockQtyManagement();
                    }
        ...
        private void initializeStockUpdateData(string purchaseCode, int counter)
        {
            ...
            {
                int dbQty = 0, dbPiece = 0;//currentQty = 0,
            ...
            stockModel.storeId = Convert.ToInt32(dicProductListUpdate["warehouse" + counter]);
        ...
        protected void ImportFileToCart(object sender, EventArgs e)
        {
        ...
        private void Import_To_Grid(string FilePath, string Extension)
        {
            ...
            int contiErrorCounter = 0;//rCnt, counter = 0,
            string errorRows = "", duppliRows = "";//pName, pDescritopn=""
            //string sku = "", store_id = "";
        ...
        {
            string currentStockedQty = "0";
            if (lblProdID.Text != "")
            {
                var qtyManagement = new QtyManagement();
                currentStockedQty = qtyManagement.getStockQty(lblProdID.Text, ddlStoreList.SelectedValue);
            }

            lblCurrentQty.Text = currentStockedQty;
