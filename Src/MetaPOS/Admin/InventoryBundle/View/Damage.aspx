...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 marginTop-10">
            <div class="section">
                <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_damage_page %></h2>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:DetailsView ID="dtlStockStatus" runat="server"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_product %>" SortExpression="prodName">
                                <ItemTemplate>
                                    <asp:Label ID="lblProdName" runat="server" Text='<%# Bind("prodName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_code %>" SortExpression="prodCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblProdCode" runat="server" Text='<%# Bind("prodCode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_supplier %>" SortExpression="supCompany">
                                <ItemTemplate>
                                    <asp:Label ID="lblSupCompany" runat="server" Text='<%# Bind("Supplier") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_category %>" SortExpression="catName">
                                <ItemTemplate>
                                    <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("Category") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_imei %>" SortExpression="imei">
                                <ItemTemplate>
                                    <asp:Label ID="lblImei" runat="server" Text='<%# Bind("imei") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_qty %>" SortExpression="qty">
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" runat="server" Text='<%# Bind("qty") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_price_buy %>" SortExpression="bPrice">
                                <ItemTemplate>
                                    <asp:Label ID="lblBPrice" runat="server" Text='<%# Bind("bPrice") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_price_sell %>" SortExpression="sPrice">
                                <ItemTemplate>
                                    <asp:Label ID="lblSPrice" runat="server" Text='<%# Bind("sPrice") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_size %>" SortExpression="size">
                                <ItemTemplate>
                                    <asp:Label ID="lblSize" runat="server" Text='<%# Bind("size") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_damaged_date %>" SortExpression="size">
                                <ItemTemplate>
                ...
                <div class="modal-footer" runat="server" id="modalFooter">
                    <button type="submit" class="btn btn-lg btnCustomize btnCloseCustom" data-dismiss="modal"><%=Resources.Language.Btn_damage_close %></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row headerDesign">
        <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal">
            <div class="section">
                <h2 class="sectionHeading"><%=Resources.Language.Btn_damage_add_damage %></h2>
                <asp:Panel ID="pnlCode" runat="server" DefaultButton="btnCheck">
                    <div class="form-group">
                        <asp:Label ID="lblCode" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_product_code %>"></asp:Label>
                    ...
                    <div class="form-group">
                        <asp:Panel runat="server" ID="pnlStore">
                            <asp:Label ID="Label3" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_store %>"></asp:Label>
                            <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnCheck" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnSearchCustom" runat="server" Text="<%$Resources:Language, Btn_damage_check %>" OnClick="btnCheck_Click" />
                    </div>
                </asp:Panel>
                <asp:Panel ID="pnlQty" runat="server" DefaultButton="btnBackToDamage">
                    <div class="form-group">
                        <asp:Label ID="lblQty" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_qty %>"></asp:Label>
                        <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group padding-bottom-10">
                        <asp:Button ID="btnBackToDamage" CssClass="btn btn-info btn-default  CRBtnDesign blockDesign btnLimpCustom btnAddOpt" ValidationGroup="reqEditDtlStock" runat="server" Text="<%$Resources:Language, Btn_damage_add_damage %>" OnClick="btnBackToDamage_Click" />
                    </div>
                </asp:Panel>
            </div>
        </div>
        <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal">
            <div class="section">
                <h2 class="sectionHeading"><%=Resources.Language.Lbl_damage_search_by_date %></h2>
                <asp:Panel ID="pnlDate" runat="server" DefaultButton="btnSearch">
                    <div class="form-group">
                        <asp:Label ID="lblSup" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Btn_damage_supplier%>"></asp:Label>
                        <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblCat" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_category %>"></asp:Label>
                        <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblFrom" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_from %>"></asp:Label>
                        <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblTo" CssClass="lbl col-sm-3 col-xs-3 control-label" runat="server" Text="<%$Resources:Language, Lbl_damage_to %>"></asp:Label>
                        <div class="col-sm-9 col-xs-9">
                    ...
                    <div class="form-group padding-bottom-25">
                        <asp:Button ID="btnSearch" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnSearchCustom" runat="server" Text="<%$Resources:Language, Btn_damage_search %>" OnClick="btnSearch_Click" />
                    </div>
                </asp:Panel>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="gridHeader">
                <div class="col-xs-4 gridTitle text-left">
                    <label><%=Resources.Language.Lbl_damage_stock_report %></label>
                </div>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdStockStatus" OnRowDataBound="grdStockStatus_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_sl %>">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_supplier %>" SortExpression="supCompany" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lblSupCompany" runat="server" Text='<%# Bind("Supplier") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Category" SortExpression="catName" Visible="False">
                        ...
                        <FooterTemplate>
                            <asp:Label ID="lblCatName" runat="server" Text="<%$Resources:Language, Lbl_damage_total %>"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_qty %>" SortExpression="qty">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_stock_total %>" SortExpression="stockTotal">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_view %>" ShowHeader="False">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_damage_restore %>" ShowHeader="False">
                        <ItemTemplate>
