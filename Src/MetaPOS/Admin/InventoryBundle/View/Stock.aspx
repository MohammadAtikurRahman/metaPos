...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 stockMargin-top">
            <div class="section stock-back-section">
                <h2 class="sectionBreadcrumb sectionBreadcrumb-stock lang-inventory-stock" id="lblHeaderTitle" runat="server"><%=Resources.Language.Title_stock_page %></h2>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <asp:DetailsView ID="dtlStock" runat="server" CssClass="mDtl dtlSize" AutoGenerateRows="False" DataKeyNames="Id"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_code %>" SortExpression="prodCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblProdCode" runat="server" Text='<%# Bind("prodCode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_supplier %>" SortExpression="supCompany">
                                <ItemTemplate>
                                    <asp:Label ID="lblSupCompany" runat="server" Text='<%# Bind("Supplier") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_category %>" SortExpression="catName">
                                <ItemTemplate>
                                    <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("CategoryName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_manufacturer %>" SortExpression="manufacturerName">
                                <ItemTemplate>
                                    <asp:Label ID="lblManufacturer" runat="server" Text='<%# Bind("manufacturerName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_product %>" SortExpression="prodName" Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblProdName" runat="server" Text='<%# Bind("prodName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_stock_qty %>" SortExpression="qty">
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" runat="server" Text='<%# Bind("qty") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_warning_qty %>" SortExpression="warningQty">
                                <ItemTemplate>
                                    <asp:Label ID="lblWarningQty" runat="server" Text='<%# Bind("warningQty") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_buy_price %>" SortExpression="bPrice" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblBPrice" runat="server" Text='<%# Bind("bPrice") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_wholesale_price %>" SortExpression="dealerPrice">
                                <ItemTemplate>
                                    <asp:Label ID="lblDealerPrice" runat="server" Text='<%# Bind("dealerPrice") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_sell_price %>" SortExpression="sPrice">
                                <ItemTemplate>
                                    <asp:Label ID="lblSPrice" runat="server" Text='<%# Bind("sPrice") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_wholesale_total %>" SortExpression="wholesaleTotal">
                                <ItemTemplate>
                                    <asp:Label ID="lblWholesaleTotal" runat="server" Text='0.00'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_sale_total %>" SortExpression="saleTotal">
                                <ItemTemplate>
                                    <asp:Label ID="lblSaleTotal" runat="server" Text='0.00'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_buy_total %>" SortExpression="buyTotal" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblBuyTotal" runat="server" Text='0.00'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_size %>" SortExpression="size">
                                <ItemTemplate>
                                    <asp:Label ID="lblSize" runat="server" Text='<%# Bind("size") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_tax %>" SortExpression="tax">
                                <ItemTemplate>
                                    <asp:Label ID="lblTax" runat="server" Text='<%# Bind("tax") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_SKU %>" SortExpression="sku">
                                <ItemTemplate>
                                    <asp:Label ID="lblSku" runat="server" Text='<%# Bind("sku") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_warranty %>" SortExpression="warranty">
                                <ItemTemplate>
                                    <asp:Label ID="lblWarranty" runat="server" Text='<%# Bind("warranty") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_IMEI %>" SortExpression="imei">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_weight %>" SortExpression="weight">
                                <ItemTemplate>
                                    <asp:Label ID="lblWeight" runat="server" Text='<%# Bind("weight") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField DataField="receivedDate" HeaderText="<%$Resources:Language, Lbl_stock_received_date %>"
                                DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="expiryDate" HeaderText="<%$Resources:Language, Lbl_stock_expiry_date %>"
                                DataFormatString="{0:dd-MMM-yyyy}" />

                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_batch_no %>" SortExpression="batchNo">
                                <ItemTemplate>
                                    <asp:Label ID="lblBatchNo" runat="server" Text='<%# Bind("batchNo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_serial_no %>" SortExpression="serialNo">
                                <ItemTemplate>
                                    <asp:Label ID="lblSerialNo" runat="server" Text='<%# Bind("serialNo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_shipment_status %>" SortExpression="shipmentStatus">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_unit %>" SortExpression="unitName">
                                <ItemTemplate>
                                    <asp:Label ID="lblUnitName" runat="server" Text='<%# Bind("unitName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_commission %>" SortExpression="commission">
                                <ItemTemplate>
                                    <asp:Label ID="lblSupplierCommission" runat="server" Text='<%# Bind("commission") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_notes %>" SortExpression="notes">
                                <ItemTemplate>
                ...
                <div class="modal-footer" runat="server" id="modalFooter">
                    <button type="submit" class="btn btn-lg btnCloseCustom closeModal" data-dismiss="modal"><%=Resources.Language.Btn_stock_close %></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row addtSection">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-15">
            <div class="col-md-4 col-sm-12 col-xs-12 text-left form-group">
                <a href="~/admin/bulk-stock?page=unit" id="btnUnitStock" runat="server" class="btn btn-success btnAddCustom btnAddOpt"><%=Resources.Language.Btn_stock_add_a_product %></a>
                <a href="~/admin/barcode" id="btnPrintbarcodeAnotherPage" runat="server" class="btn btn-info" target="_blank"><%=Resources.Language.Btn_stock_print_your_barcode %></a>         
                <a href="/admin/ImportProductFromApi?action=stock" class="btn btn-primary btnPrintCustom btnAddOpt"><%=Resources.Language.Btn_stock_master_db %></a>
            ...
            <div class="col-md-8 col-xs-12 col-sm-12 text-right text-left form-inline">
                ...
                <div class="btn-group" role="group">
                    <asp:Button ID="btnShowAllProducts" CssClass="btn btn-primary btnPrintCustom margin-bottom-10 margin-left-0" runat="server" Text="<%$Resources:Language, Btn_stock_show_all_products %>" OnClick="btnShowAllProducts_OnClick" />
                    <asp:Button ID="btnPrint" CssClass="btn btn-primary btnPrintCustom margin-bottom-10" runat="server" Text="<%$Resources:Language, Btn_stock_print_all_stock %>" OnClick="btnPrint_Click" />
                    <asp:Button ID="btnPrintImage" CssClass="btn btn-primary btnPrintCustom margin-bottom-10" runat="server" Text="<%$Resources:Language, Btn_stock_print_barcode %>" OnClick="btnPrintImage_Click" />

                    <!-- -->
                    <button type="button" id="btnExportToCsvModal" runat="server" class="btn btn-primary btnPrintCustom btn-export margin-bottom-10" data-toggle="modal" data-target=".export-to-csv"><%=Resources.Language.Btn_stock_export %></button>
                    <a href="/admin/import?action=stock" class="btn btn-primary btnPrintCustom btn-export"><%=Resources.Language.Btn_stock_import %></a>
                    <!-- -->
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="gridHeader">
                <div class="col-xs-12 col-sm-12 gridTitle two-line-grid-title text-left">
                    <label class="col-xs-6 col-sm-6"><%=Resources.Language.Lbl_stock_stock_report %></label>
            ...
            <div class="">
                <div class="gridTitle form-inline">
                    <asp:Panel ID="PanelSearchStock" CssClass="" runat="server">
                        ...
                        <div class="form-group stock-search-field">
                            <asp:DropDownList ID="ddlWarehouseList" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlWarehouseList_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group stock-search-field">
                        ...
                        <div class="form-group stock-search-field">
                            <asp:DropDownList runat="server" ID="ddlStockStatus" CssClass="margin-left-4" AutoPostBack="True" OnSelectedIndexChanged="ddlStockStatus_OnSelectedIndexChanged">
                                <asp:ListItem Value="1" Selected="True" Text="<%$Resources:Language, Lbl_stock_active %>"></asp:ListItem>
                                <asp:ListItem Value="0" Text="<%$Resources:Language, Lbl_stock_non_active %>"></asp:ListItem>
                            </asp:DropDownList>
                        </div>

                        <div class="form-group stock-search-field">
                            <asp:TextBox ID="txtSearch" CssClass="form-control margin-left-4" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_OnTextChanged" placeholder="<%$Resources:Language, Lbl_stock_search %>"></asp:TextBox>
                        </div>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><%=Resources.Language.Lbl_stock_stock_report %></h4>
                    </div>
                    <div class="modal-body">
                        <asp:RadioButtonList ID="ddlExportCSVOption" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            <asp:ListItem Text=" <%$Resources:Language, Lbl_stock_summary %>" Value="0" Selected="True"></asp:ListItem>
                            <asp:ListItem Text=" <%$Resources:Language, Lbl_stock_detail %>" Value="1"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    <div class="modal-footer">
                        <asp:UpdatePanel ID="UpdatePanelExport" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btnExportToCsv" CssClass="btn btn-primary btnPrintCustom" runat="server" Text="<%$Resources:Language, Btn_stock_export_csv %>" OnClick="btnExportToCsv_OnClick" />
                            </ContentTemplate>
                            <Triggers>
        ...
        <div class="col-md-12">
            <div class="scroll">
                ...
                <asp:GridView ID="grdStock"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_id %>" SortExpression="prodID">
                            <ItemTemplate>
                                <asp:Label ID="lblProdID" runat="server" Text='<%# Bind("prodID") %>' CssClass="grd-product-Id"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_product_name %>" SortExpression="prodName">
                            <ItemTemplate>
                                <asp:Label ID="lblProdName" runat="server" Text='<%# Bind("prodName") %>'></asp:Label>
                                <asp:Label ID="lblAttributeLabel" runat="server" Text=""></asp:Label>
                                <asp:Label ID="lblAttributeValue" runat="server" Text='<%# Bind("attributeRecord") %>' Visible="false"></asp:Label>

                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_barcode %>" SortExpression="prodCode" Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="lblProdCode" runat="server" Text='<%# Bind("prodCode") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_stock_qty %>" SortExpression="qty" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_stock_qty %>" SortExpression="qty" ItemStyle-CssClass="">
                            <ItemTemplate>
                                <%--<asp:Label ID="Label1" runat="server" Text='' CssClass="stock-qty-loader grd-product-qty"></asp:Label>--%>
                                <asp:Label ID="lblOrginalQty" runat="server" Text='<%# String.IsNullOrEmpty(Eval("qty").ToString())? "0" : Eval("qty").ToString()  %>' CssClass="grd-product-qty"></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lblQtyFooter" runat="server" Text="20"></asp:Label>
                            </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_buy_price %>" SortExpression="bPrice">
                            <ItemTemplate>
                                <asp:Label ID="lblBPrice" runat="server" Text='<%# Bind("bPrice") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_company_price %>" SortExpression="comPrice">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_sale_price %>" SortExpression="sPrice">
                            <ItemTemplate>
                                <asp:Label ID="lblSPrice" runat="server" Text='<%# Bind("sPrice") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_buy_total %>" SortExpression="buyTotal">
                            <ItemTemplate>
                                <asp:Label ID="lblBuyTotal" runat="server" Text='<%# ((Convert.ToDecimal(Eval("bPrice")))*(Convert.ToDecimal(Eval("qty")))) %>'></asp:Label>


                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_free_total %>" SortExpression="freeTotal">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_retail_total %>" SortExpression="soldTotal">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_date %>" SortExpression="entryDate" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_stock_action %>">
                            <ItemTemplate>
                                <div class="btn-group btn-stock-action">
                                    <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <%=Resources.Language.Btn_stock_action %> <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu btn-stock-dropdown-position">
                                        <li>
                                            <asp:LinkButton ID="btnGrdView" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="Select" Text="<%$Resources:Language, Lbl_stock_view %>" data-toggle="tooltip" data-placement="top" title="View " data-trigger="hover"></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnVariantProduct" runat="server" CssClass='<%# ShowButtonVariantProduct(Eval("isParent")) %>' CausesValidation="False" CommandName="Variant" Text="<%$Resources:Language, Lbl_stock_variant_product %>" data-toggle="tooltip" data-placement="top" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" title="Variant Product " data-trigger="hover"></asp:LinkButton></li>
                                        <li class="disNone">
                                            <asp:LinkButton ID="btnAddVariant" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="addVariant" Text="<%$Resources:Language, Lbl_stock_add_variant %>" data-toggle="tooltip" data-placement="top" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" title="Add Variant " data-trigger="hover"></asp:LinkButton></li>
                                        <li><a href="#">
                                            <asp:LinkButton ID="btnGrdEdit" runat="server" CssClass="btn btn-design text-align-left btnEditOpt" CausesValidation="False" CommandName="Edit" Text="<%$Resources:Language, Lbl_stock_edit %>" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" title="Edit "></asp:LinkButton></li>
                                        <li class="transfer-opt disNone">
                                            <asp:LinkButton ID="btnGrdTransfer" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="Transfer" Text="<%$Resources:Language, Lbl_stock_transfer %>" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" data-toggle="tooltip" data-placement="top" title="Transfer " data-trigger="hover"></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnStockStatus" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="StockStatus" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" title="Sale Status" Text="<%$Resources:Language, Lbl_stock_stock_status %>"> </asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnCustomBarcode" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="customBarcode" CommandArgument="<%#((GridViewRow)Container).RowIndex %>" Text="<%$Resources:Language, Lbl_stock_print_custom %>" data-toggle="tooltip" data-placement="top" title="Print Custom Barcode " data-trigger="hover"></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnPrintBarcode" runat="server" CssClass="btn btn-design text-align-left" CausesValidation="False" CommandName="Print" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" title="Print Barcode" Text="<%$Resources:Language, Lbl_stock_print_barcode %>"></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnGrdDelete" CssClass='<%# ShowButtonDelete(Eval("active")) %>' OnClientClick=" return confirm('Are you sure you want to delete selected record (This product are not found in any store) ?') " runat="server" CausesValidation="False" CommandName="Delete" Text="<%$Resources:Language, Lbl_stock_delete %>" title="Delete Stock"></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton ID="btnGrdRestore" CssClass='<%# ShowButtonRestore(Eval("active")) %>' runat="server" CommandArgument="<%#((GridViewRow) Container).RowIndex %>" CausesValidation="False" OnClientClick=" return confirm('Are u want to restore product') " CommandName="Restore" Text="<%$Resources:Language, Lbl_stock_restore %>" title="Restore Stock"></asp:LinkButton></li>
                                    </ul>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div>
                <asp:Label ID="lblSummary" runat="server" CssClass="footer-summary pull-right" Text=""></asp:Label>
            </div>
        </div>
        ...
        <div id="stockBarcodePrintOption" class="modal fade" role="dialog">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title"><%=Resources.Language.Lbl_stock_print_barcode %></h4>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="form-group">
                                <asp:TextBox runat="server" ID="txtInputStock" CssClass="form-control" placeholder="<%$Resources:Language, Lbl_stock_enter_qty %>"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <asp:Button runat="server" ID="btnStockBarcodePrintFromModal" Text="<%$Resources:Language, Btn_stock_print %>" CssClass="btn btn-info" OnClick="btnStockBarcodePrintFromModal_OnClick" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><%=Resources.Language.Btn_stock_close %></button>
                    </div>
                </div>
        ...
        <div id="noBarcodeModal" class="modal fade" role="dialog">
            <div class="modal-dialog modal-md">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title"><%=Resources.Language.Btn_stock_print_barcode %></h4>
                    </div>
                    <div class="modal-body">
        ...
        <div id="stockTransfer" class="modal fade" role="dialog">
            <div class="modal-dialog ">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title"><%=Resources.Language.Lbl_stock_transfer_stock %></h4>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-6"><%=Resources.Language.Lbl_stock_product_name %></label>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-6"><%=Resources.Language.Lbl_stock_available_qty %></label>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-6"><%=Resources.Language.Lbl_stock_transfer_qty %></label>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-6"><%=Resources.Language.Lbl_stock_shift_to %></label>
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="ddlShiftTo" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <asp:Button ID="btnStockTransfer" runat="server" Text="<%$Resources:Language, Btn_stock_transfer %>" CssClass="btn btn-primary transfer" OnClick="btnStockTransfer_OnClick" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-md">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:SqlDataSource runat="server" ID="dsGridVariantProd" SelectCommand="SELECT [prodID], [prodName], [qty], [bPrice], [sPrice], [attributeRecord], [fieldRecord], [parentId], [isChild] FROM [StockInfo] WHERE ([parentId] = @parentId)">
                            <SelectParameters>
    ...
    <script src="<%=ResolveUrl("~/Admin/InventoryBundle/Script/main.js?v0.039") %>"></script>
    ...
    <script>
        ...
        prm.add_endRequest(function (s, e) {
            ...
            script.src = '/Admin/InventoryBundle/Script/main.js?v0.005';
            script.type = 'text/javascript';
