...
namespace MetaPOS.Admin.InventoryBundle.View
{
    ...
    public partial class Return :BasePage 
    {
        ...
        private static decimal bPrice, stockTotalTotal, qtyTotal;//,returnTotal;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ddlSup.Items.Insert(0, new ListItem(Resources.Language.Lbl_return_search_all, "0"));
                ddlCat.Items.Insert(0, new ListItem(Resources.Language.Lbl_return_search_all, "0"));
        ...
        private void refreshGrd(string query)
        {
            ...
            try
            {
                var dtReturn = sqlOperation.getDataTable(query);
        ...
        private void searchResult()
        {
            ...
            query =
                ...
                ddlSup.SelectedValue + "' OR '" + ddlSup.SelectedValue + "' = '0') AND (tbl.catName = '" + ddlCat.SelectedValue + "' OR '" +
                ddlCat.SelectedValue + "' = '0') AND (tbl.statusDate >= '" + searchFrom.ToShortDateString() + "' OR '" +
        ...
        protected void grdStockStatus_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            if (currentDate == returnDate)
            {
                ...
                string returnQty = (grdStockStatus.Rows[e.NewEditIndex].FindControl("lblQty") as Label).Text;
                ...
                //string currentTotalStockQty = stock.getCurrentTotalStockQty(returnQty, productId);
                decimal stockTotal = stock.getStockTotalPrice(productId, stockBPrice, returnQty);
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            if (txtCode.Text == "")
            {
                ScriptMessage(Resources.Language.Lbl_return_product_code_is_required, MessageType.Warning);
                return;
            }
        ...
        protected void btnBackToReturn_Click(object sender, EventArgs e)
        {
            ...
            query = "BEGIN TRANSACTION " +
                    ...
                    "COMMIT";
            var msg = sqlOperation.fireQuery(query);

            if (!msg)
            {
                ScriptMessage("Return failed", MessageType.Success);
                return;
            }
            ...
            commonFunction.cashTransaction((-totalReturnAmt), 0, "Return", supplierId, "", "Product Id: " + prodId, "0", "1");
        ...
        private void SearchReturnProduct()
        {
            ...
            txtQty.Text = commonFunction.getStockQtyByUnitMeasurement(ProdIdReturn, ddlStore.SelectedValue);
