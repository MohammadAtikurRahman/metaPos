...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="section">
                <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_token %></h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="gridHeader">
                <div class="col-xs-3 gridTitle text-left">
                    <label><%=Resources.Language.Lbl_token_token_report %></label>
                </div>
                <div class="col-xs-9 gridTitle text-right form-inline">
                    <asp:Panel runat="server" ID="PNL" DefaultButton="">
                        ...
                        <span class="lang-sales-to float-left"><%=Resources.Language.Lbl_token_to %></span>
                        <div class="form-group float-left">
                        ...
                        <div class="form-group float-left margin-left-5">
                            <asp:TextBox runat="server" ID="txtSearch" CssClass="form-control " placeholder="<%$Resources:Language, Lbl_token_search %>" AutoPostBack="true"></asp:TextBox>
                        </div>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdTokenInfo" OnRowDataBound="grdTokenInfo_RowDataBound" OnRowCommand="grdTokenInfo_RowCommand"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_token_sl %>" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <%#Container.DataItemIndex + 1 %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="billNo" HeaderText="<%$Resources:Language, Lbl_token_invoice_no%>" SortExpression="billNo" ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField DataField="cusID" HeaderText="<%$Resources:Language, Lbl_token_customer_id %>" SortExpression="cusID" ItemStyle-Width="20%"></asp:BoundField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_token_token %>" SortExpression="token">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_token_disc_amount %>" SortExpression="discAmt">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_token_date %>" SortExpression="entryDate" ItemStyle-Width="15%">
                        <ItemTemplate>
