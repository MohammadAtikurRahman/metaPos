...
$.ajax({
    ...
    success: function (data) {
        ...
        $('#lblDate').text(moment(Date(jsonData[0].entryDate.substr(6))).format('DD MMMM YYYY'));
        //$('#lblDate').text($.formattedDate(new Date(parseInt(jsonData[0].entryDate.substr(6))), 'DD MMMM YYYY'));
        $('#lblTime').text(moment(Date(jsonData[0].entryDate.substr(6))).format('h:mm:ss a'));

        if (jsonData[0].isAutoSalesPerson == false)
            $('#lblSaleBy').text(jsonData[0].staffName == null ? "" : jsonData[0].staffName);
        else
            $('#lblSaleBy').text(jsonData[0].title == null ? "" : jsonData[0].title);
        ...
        console.log("isVat:", columnAccess[0]["isVatPrint"]);
        if (columnAccess[0]["isVatPrint"] == "1") {
                ...
                success: function (dataUnit) {
                    ...
                    $.ajax({
                        ...
                        success: function (dataAttr) {
                            ...
                            console.log("AF:", columnAccess[0]["isPrintWarranty"], " FA:", value.warranty);
                            ...
                            tar += "<td>" + salePrice + "</td>" +
                                "<td>" + ins1000Sep(formatNum(((parseFloat(qty) * parseFloat(salePriceOriginal)) - (parseFloat(returnQty) * parseFloat(salePriceOriginal))).toFixed(2))) + "</td>" +
                                "</tr>";
                            couterSL++;
