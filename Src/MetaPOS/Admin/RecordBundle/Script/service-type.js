...
function eventChange() {
    ...
    checkPagePermission("ServiceType");
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;<span class='lang-record-add-service-type'>" + Add_serviceType + "</span>");
        $("#btnUpdate").hide();
        $("#btnSave").show();
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;" + Edit_serviceType + "");
        $("#btnSave").hide();
        $("#btnUpdate").show();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.d === "success") {
                    ...
                    showModalOutput("Service Type is exist! Try different name.", "warning");
                }
                else {
                    saveAction();
                }
