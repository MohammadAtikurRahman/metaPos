                    ...
                    "buttons": [
                        {
                            ...
                            "customize": function (win) {
                                ...
                                $(win.document.body).prepend('<p style="border-bottom: 1px solid #ccc; padding-bottom: 10px; padding-top: 3px;"><b>Field List</b></p>');
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;<span class='lang-record-add-new-field'>" + Add_field + "</span>");
        $("#btnUpdate").hide();
        $("#btnSave").show();
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;" + Edit_field + "");
        $("#btnSave").hide();
        $("#btnUpdate").show();
    ...
    function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.d === "success") {
                    showModalOutput("Field name is exist! Try different name.", "warning");
                }
                else {
                    saveAction();
                }
...
function validateForm() {
    ...
    var field = $('#txtName').val();

    if (field == "") {
        validate = false;
        showModalOutput("Field name required!", "warning");
    }
