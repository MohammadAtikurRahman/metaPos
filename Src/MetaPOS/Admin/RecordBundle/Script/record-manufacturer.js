...
function eventChange() {
    ...
    checkPagePermission("Manufacturer");
                   ...
                   "buttons": [
                       {
                           ...
                           "customize": function (win) {
                               ...
                               $(win.document.body).prepend('<p style="border-bottom: 1px solid #ccc; padding-bottom: 10px; padding-top: 3px;"><b>Manufacturer List</b></p>');
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;<span class='lang-record-add-manufacturer'>"+Add_manufacturer+"</span>");
        $("#btnUpdate").hide();
        $("#btnSave").show();
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;" + Edit_manufacturer + "");
        $("#btnSave").hide();
        $("#btnUpdate").show();
...
function saveActionManufacturer() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if ($('#txtName').val() === $('#formModal').data('name')) {
                    ...
                    showModalOutput("Manufacturer name is exist! Try different name.", "warning");
                }
                else {
                    updateAction();
                }
...
function validateForm() {
    ...
    var manufacturerName = $('#txtName').val();


    if (manufacturerName === "") {
        validate = false;
        showModalOutput("Manufacturer field required!", "warning");
        $('.validateName').append();
    }
