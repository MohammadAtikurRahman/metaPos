                    ...
                    "buttons": [
                        {
                            ...
                            "customize": function (win) {
                                ...
                                $(win.document.body).prepend('<p style="border-bottom: 1px solid #ccc; padding-bottom: 10px; padding-top: 3px;"><b>Category List</b></p>');
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp;<span class='lang-record-add-category'>"+ Add_category +"</span>");
        $("#btnUpdate").hide();
        $("#btnSave").show();
...
$(document).on("click",
    ...
    function () {
        resetFormValue();
        $("#formModal .modal-title").html("<i class='fa fa-file-text' aria-hidden='true'></i>&nbsp; " + Edit_category + "");
        $("#btnSave").hide();
        $("#btnUpdate").show();
