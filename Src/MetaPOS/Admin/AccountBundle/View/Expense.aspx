...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="section">
                <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_expense %></h2>
    ...
    <div class="row headerDesign">
        ...
        <asp:Panel ID="pnlCashOut" runat="server" DefaultButton="btnCashOutAdd">
            <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    <h2 class="sectionHeading"><%=Resources.Language.Lbl_expense_add_expense %></h2>
                    <div class="form-group disNone">
                        <asp:Label ID="lblCashOutType" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_particular %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" id="divCashOutTypeSup" runat="server">
                        <asp:Label ID="lblCashOutTypeSup" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_particular %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" id="divCashOutDescriptions" runat="server" visible="true">
                        <asp:Label ID="lblCashOutMainDescr" CssClass="lbl col-sm-4 control-label " runat="server" Text="<%$Resources:Language, Lbl_expense_description %>"></asp:Label>
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtCashOutMainDescr" CssClass="form-control" runat="server" TextMode="MultiLine"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="lblCashOutAmount" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_amount %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label3" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_expense_date %>"></asp:Label>
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtExpenseDate" CssClass="form-control datepickerCSS" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="padding-bottom-74">
                        <asp:Button ID="btnCashOutAdd" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnAddCustom btnAddOpt" runat="server" Text="<%$Resources:Language, Btn_expense_add %>" OnClick="btnCashOutAdd_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnCashSearch">
            <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    <h2 class="sectionHeading"><%=Resources.Language.Lbl_expense_search %></h2>
                    <div class="form-group" id="divStoreList" runat="server">
                        <asp:Label ID="Label2" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_store %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group"  runat="server" id="divUserList">
                        <asp:Label ID="Label9" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_user %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblCashSearchType" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_particular %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateFrom" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_from %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <asp:Label ID="lblSearchDateTo" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_expense_to %>"></asp:Label>
                        <div class="col-sm-8">
                    ...
                    <div class="padding-bottom-45">
                        <asp:Button ID="btnCashSearch" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnSearchCustom" runat="server" Text="<%$Resources:Language, Lbl_expense_search %>" OnClick="btnCashSearch_Click" />
                    </div>
                </div>
            </div>
        </asp:Panel>
    ...
    <div class="row gridTopButton">
        <div class="btn-group btnGroupDesignLeft" role="group">
            <asp:Button ID="btnAddPaticular" CssClass="btn btn-info btnAddCustom btnAddOpt" runat="server" Text="<%$Resources:Language, Btn_expense_add_particular %>" OnClick="btnAddPaticular_Click" />
        </div>
        ...
        <div class="col-md-12">
            <div class="gridHeader">
                <div class="col-md-4 col-sm-4 col-xs-3 gridTitle text-left">
                    <label><%=Resources.Language.Lbl_expense_expense_report %></label>
                </div>
        ...
        <div class="col-md-12 scroll">
            ...
            <asp:GridView ID="grdCashReportInfo" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_sl%>">
                        <ItemTemplate>
                            <%#Container.DataItemIndex + 1 %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_source %>" SortExpression="cashType">
                        <ItemTemplate>
                            <asp:Label ID="lblCashType" runat="server" Text='<%# Bind("cashType") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_particular %>" SortExpression="Particular" Visible="true">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_details %>" SortExpression="mainDescr" ItemStyle-Width="30%">
                        <ItemTemplate>
                            <asp:Label ID="lblMainDescr" runat="server" Text='<%# Bind("mainDescr") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lblMainDescr" runat="server" Text="<%$Resources:Language, Lbl_expense_total %> "></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_cash_in %>" SortExpression="cashIn" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_amount %>" SortExpression="cashOut">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_date %>" SortExpression="entryDate">
                        <ItemTemplate>
                            <asp:Label ID="lblEntryDate" runat="server" Text='<%# Bind("entryDate", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_store %>" SortExpression="storeName">
                        <ItemTemplate>
                            <asp:Label ID="lblStoreName" runat="server" Text='<%# Bind("storeName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_expense_delete %>" ShowHeader="False" Visible="false">
                        <ItemTemplate>
