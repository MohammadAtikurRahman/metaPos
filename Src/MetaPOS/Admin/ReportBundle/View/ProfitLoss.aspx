        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
                <div id="divHeaderPanel" class="profit-title">
                    <label class="title"><%=Resources.Language.Title_profitLoss %></label>
                </div>
            ...
            <div class="">
                <div class="col-md-3 col-sm-6 col-xs-6 ">
                    <div class="section profit-loss-design">
                        ...
                        <b><%=Resources.Language.Lbl_profitLoss_revenue_amount %></b>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="section profit-loss-design">
                        ...
                        <b><%=Resources.Language.Lbl_profitLoss_expense_amount %></b>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="section profit-loss-design">
                        ...
                        <b><%=Resources.Language.Lbl_profitLoss_supplier_due_amount%></b>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="section profit-loss-design">
                        ...
                        <b runat="server" id="lblProfitLossTxt"></b>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="gridHeader">
                    <div class="col-md-3 col-sm-3 col-xs-4 gridTitle text-left">
                        <label><%=Resources.Language.Lbl_profitLoss_loss_profit_history %></label>
                    </div>
                    <div class="col-md-9 col-sm-9 col-xs-8 gridTitle text-right form-inline">
                        ...
                        <div class="form-group stock-search-field chk-profit-loss float-left">
                            <asp:CheckBox ID="chkAllProfitLoss" runat="server" Text="<%$Resources:Language, Lbl_profitLoss_all_profit_loss %>" AutoPostBack="True" OnCheckedChanged="txtSearch_OnTextChanged" />
                        </div>
            ...
            <div class="col-md-12 scroll">
                ...
                <asp:GridView ID="grdProfitLoss"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_profitLoss_sl %>">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="cashType" HeaderText="<%$Resources:Language, Lbl_profitLoss_cash_type %>" SortExpression="cashType"></asp:BoundField>
                        <asp:BoundField DataField="descr" HeaderText="descr" SortExpression="descr" Visible="False"></asp:BoundField>
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_profitLoss_dated %>" SortExpression="entryDate">
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Bind("entryDate","{0:dd-MMM-yyyy}") %>' ID="Label1"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_profitLoss_cashin %>" SortExpression="cashIn">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_profitLoss_cashout %>" SortExpression="cashOut">
                            <ItemTemplate>
