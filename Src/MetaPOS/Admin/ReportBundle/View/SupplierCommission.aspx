...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div id="divHeaderPanel">
                ...
                <label class="title"><%=Resources.Language.Title_supplierCommission %></label>
    ...
    <script>
        ...
        var select_category = "<% =Resources.Language.Lbl_supplierCommission_select_category %>";
        var ID = "<% =Resources.Language.Lbl_supplierCommission_id %>";
        var Item_Name = "<% =Resources.Language.Lbl_supplierCommission_item_name %>";
        var P_Code = "<% =Resources.Language.Lbl_supplierCommission_p_code %>";
        var Qty = "<% =Resources.Language.Lbl_supplierCommission_qty %>";
        var Commission = "<% =Resources.Language.Lbl_supplierCommission_commission %>";
        var Amount = "<% =Resources.Language.Lbl_supplierCommission_amount %>";
        var cDate = "<% =Resources.Language.Lbl_supplierCommission_date %>";
        var Store = "<% =Resources.Language.Lbl_supplierCommission_store %>";
