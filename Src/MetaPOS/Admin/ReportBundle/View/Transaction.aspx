...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="section">
                <div class="row">
                    <h2 class="sectionBreadcrumb col-md-8"><%=Resources.Language.Title_transaction %></h2>
        ...
        <asp:Panel ID="pnlCashIn" runat="server" DefaultButton="btnCashInAdd">
            <div class="col-md-4 col-sm-12 col-xs-12 form-horizontal">
                <div class="stockfieldHeight singleCashReportField section">
                    <h2 class="sectionHeading"><%=Resources.Language.Lbl_transaction_cash_in %></h2>
                    <div class="form-group">
                        <asp:Label ID="lblCashInType" CssClass="lbl col-sm-4 control-label" runat="server" Text="<%$Resources:Language, Lbl_transaction_particular %>"></asp:Label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 gridTitle form-inline transection">
                    ...
                    <div class="form-group float-left margin-left-7">
                        ...
                        <asp:DropDownList ID="ddlCashSearchType" CssClass=" form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCashSearchType_SelectedIndexChanged">
                            <asp:ListItem Value="SearchAll" Text="<%$Resources:Language, Lbl_transaction_search_all%>"></asp:ListItem>
                            <asp:ListItem Value="0" Text="<%$Resources:Language, Lbl_transaction_supply %>"></asp:ListItem>
                            <asp:ListItem Value="5" Text="<%$Resources:Language, Lbl_transaction_sales %>"></asp:ListItem>
                            <asp:ListItem Value="3" Text="<%$Resources:Language, Lbl_transaction_receive %>"></asp:ListItem>
                            <asp:ListItem Value="2" Text="<%$Resources:Language, Lbl_transaction_expense %>"></asp:ListItem>
                            <asp:ListItem Value="1" Text="<%$Resources:Language, Lbl_transaction_salary %>"></asp:ListItem>
                            <asp:ListItem Value="4" Text="<%$Resources:Language, Lbl_transaction_banking %>"></asp:ListItem>
                            <asp:ListItem Value="6" Text="<%$Resources:Language, Lbl_transaction_advance %>"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    ...
                    <span class="float-left"><%=Resources.Language.Lbl_transaction_to  %></span>
                    <div class="form-group float-left margin-left-7">
                    ...
                    <div class="form-group float-left margin-left-7">
                        <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" AutoPostBack="true" placeholder="<%$Resources:Language, Lbl_transaction_search %>" OnTextChanged="btnCashSearch_Click"></asp:TextBox>
                    </div>
                    <div class="form-group float-left margin-left-7">
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdCashReportInfo" OnRowDataBound="grdCashReportInfo_RowDataBound" OnRowDeleted="grdCashReportInfo_RowDeleted"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_sl %>" ItemStyle-Width="5%">
                        <ItemTemplate>
                            <%#Container.DataItemIndex + 1 %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_source %>" SortExpression="cashType" ItemStyle-Width="15%">
                        <ItemTemplate>
                            <asp:Label ID="lblCashType" runat="server" Text='<%# Bind("cashType") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_particular %>" SortExpression="descr" ItemStyle-Width="15%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_details %>" SortExpression="mainDescr" ItemStyle-Width="20%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_store %>" SortExpression="storeName" ItemStyle-Width="15%">
                        <ItemTemplate>
                            <asp:Label ID="lblStore" runat="server" Text='<%# Bind("storeName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_date %>" SortExpression="entryDate" ItemStyle-Width="10%">
                        <ItemTemplate>
                            <asp:Label ID="lblEntryDate" runat="server" Text='<%# Bind("entryDate", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lblMainTotal" runat="server" Text="<%$Resources:Language, Lbl_transaction_total %>"></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_cash_in %>" SortExpression="cashIn" ItemStyle-Width="10%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_cash_out %>" SortExpression="cashOut" ItemStyle-Width="10%">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_cash_in_hand %>" SortExpression="cashInHand" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lblCashInHand" runat="server" Text='<%# Bind("cashInHand") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_transaction_delete %>" ShowHeader="False" Visible="false">
                        <ItemTemplate>
