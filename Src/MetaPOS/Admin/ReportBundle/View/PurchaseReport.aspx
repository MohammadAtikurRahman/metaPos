    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div id="divHeaderPanel">
                <label class="title"><%=Resources.Language.Title_purchaseReport %></label>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="gridHeader">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 gridTitle form-inline">
                    ...
                    <div class="form-group margin-bottom-10 float-left margin-left-7">
                        <asp:TextBox runat="server" ID="txtSearch" placeholder="<%$Resources:Language, Lbl_purchaseReport_search %>" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtSearch_OnTextChanged"></asp:TextBox>
                    </div>
        ...
        <div class="col-md-12 scroll">
            <asp:GridView ID="grdPurchaseReportInfo"
                ShowFooter="True"
                    ...
                    AllowPaging="true">
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_purchaseReport_code %>" SortExpression="purchaseCode">
                        <EditItemTemplate>
                    ...
                    <asp:BoundField DataField="supCompany" HeaderText="<%$Resources:Language, Lbl_purchaseReport_supplier %>" SortExpression="supCompany"></asp:BoundField>
                    <asp:BoundField DataField="qty" HeaderText="<%$Resources:Language, Lbl_purchaseReport_qty %>" SortExpression="qty"></asp:BoundField>
                    <asp:BoundField DataField="stockTotal" HeaderText="<%$Resources:Language, Lbl_purchaseReport_purchase_amount %>" SortExpression="stockTotal"></asp:BoundField>
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_purchaseReport_date %>" SortExpression="statusDate">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_purchaseReport_store %>" SortExpression="storeName">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%# Bind("storeName") %>' ID="LabelStore"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="<%$Resources:Language, Lbl_purchaseReport_action %>">
                        <ItemTemplate>
