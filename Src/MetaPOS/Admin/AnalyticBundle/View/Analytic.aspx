    ...
    <div class="analytic-reprot">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
                <div class="section">
                    <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_analyticReport %></h2>
                    ...
                    <div class="form-inline">
                        <div class="sale-report-search">
                            ...
                            <div class="form-group">
                                <label class="lang-reports-store"><%=Resources.Language.Lbl_analyticReport_store %></label>
                            ...
                            <div class="form-group">
                                <label><%=Resources.Language.Lbl_analyticReport_to %></label>
                                <asp:TextBox ID="txtTo" runat="server" CssClass="form-control  datepickerCSS"
                                    onchange="optionDateSearchType_onClick()"></asp:TextBox>
                            </div>
                            <br/>
                             <div class="btn-group col-sm-12 col-md-12" data-toggle="buttons-radio" id="optionDateSearchType" runat="server">
                                <button class="btn active" value="day"><%=Resources.Language.Lbl_analyticReport_day %></button>
                                <button class="btn disNone" value="week"><%=Resources.Language.Lbl_analyticReport_week %></button>
                                <button class="btn" value="month"><%=Resources.Language.Lbl_analyticReport_month %></button>
                                <button class="btn" value="year"><%=Resources.Language.Lbl_analyticReport_year %></button>
                            </div>

                        </div>
                    </div>
                    <div id="chart" class="chart-report">
                   </div>
                </div>
            </div>
        </div>
