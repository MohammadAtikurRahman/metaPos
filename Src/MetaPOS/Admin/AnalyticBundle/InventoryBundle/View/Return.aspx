...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 marginTop-10">
            <div class="section">
                <h2 class="sectionBreadcrumb lang-inventory-return">Return</h2>
                ...
                <div class="modal-body">
                    <asp:DetailsView ID="dtlStockStatus" runat="server"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Returned Date" SortExpression="size">
                                <ItemTemplate>
    ...
    <div class="row headerDesign">
        <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal">
            <div class="section">
                <h2 class="sectionHeading lang-inventory-back-to-return">Back To Return</h2>
                ...
                <asp:Panel ID="pnlQty" runat="server" DefaultButton="btnBackToReturn">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-9">
                            ...
                            <asp:RegularExpressionValidator ID="revQty" runat="server" ControlToValidate="txtQty" ErrorMessage="Invalid!" ValidationExpression="^\-?([1-9]\d?|1\d{1,2}|200)((\.|,)\d{0,2})?$" Display="Dynamic" CssClass="crStyle"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    ...
                    <div class="form-group padding-bottom-10">
                        <asp:Button ID="btnBackToReturn" CssClass="btn btn-info btn-default  CRBtnDesign blockDesign btnLimpCustom btnAddOpt" ValidationGroup="reqEditDtlStock" runat="server" Text="Back To Return" OnClick="btnBackToReturn_Click" />
                    </div>
                </asp:Panel>
            </div>
        </div>
