    ...
    <div class="warningQty">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 marginTop-10">
                <div class="section">
                    <h2 class="sectionBreadcrumb lang-inventory-stock-warning-qty">Stock Warning Qty</h2>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="">
                    <div class="col-md-12 col-sm-12 col-xs-12 gridTitle text-left">
                        <label class="lang-invenroty-warning-stock-history">Warning Stock History</label>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 gridTitle text-right form-inline">
                        ...
                        <div class="form-group stock-search-field float-left margin-left-7">
                            <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged" placeholder="Search..."></asp:TextBox>
                        </div>
                ...
                <div class="scroll">
                    <asp:GridView ID="grdWarningQty" runat="server" AutoGenerateColumns="False" CssClass="mGrid gBox scrollBar"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="catName" HeaderText="Category" SortExpression="catName" ItemStyle-Width="25%"></asp:BoundField>
                            <asp:BoundField DataField="stockqty" HeaderText="Current Qty" SortExpression="stockqty" ItemStyle-Width="15%"></asp:BoundField>
                            <asp:BoundField DataField="warningQty" HeaderText="Warning Qty" SortExpression="warningQty" ItemStyle-Width="15%"></asp:BoundField>
