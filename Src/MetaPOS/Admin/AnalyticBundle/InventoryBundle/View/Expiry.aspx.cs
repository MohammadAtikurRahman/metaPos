...
{
    public partial class Expiry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txtDateFrom.Text = txtDateTo.Text = commonFunction.GetCurrentTime().ToString("dd-MM-yyyy");
        ...
        protected void grdExpiryQty_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ((Label)e.Row.FindControl("lblExpiryDay")).Text = totalDays + " Day (" + expiryDate.ToString("dd-MM-yyyy") + ")";
