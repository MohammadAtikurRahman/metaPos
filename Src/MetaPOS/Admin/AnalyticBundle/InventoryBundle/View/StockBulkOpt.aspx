...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="<%= ResolveUrl("~/Css/Designer.css") %>" rel="stylesheet" type="text/css" />
            ...
            <div class="purchaseMarginTop col-md-12 col-sm-12 col-xs-12">
                <div class="section">
                    <h2 class="sectionBreadcrumb">
                        <asp:Label ID="lblStockTitle" CssClass="lang-purchase" runat="server" Text="Purchase"></asp:Label>
                    </h2>
        ...
        <div class="row">
                ...
                <div class="stockfieldHeight singleStockField section">
                    ...
                    <asp:Panel ID="pnlAdd" runat="server">
                        ...
                        <div class="form-group" id="divWarehouse" runat="server">
                            <asp:Label ID="Label13" CssClass="lbl col-xs-4 col-sm-4 control-stock-label lang-store" runat="server" Text="Store <span class='required'>*</span>"></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                                <asp:DropDownList runat="server" ID="ddlWarehouse" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlWarehouse_OnSelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group" id="divLocation" runat="server" visible="false">
                            <asp:Label ID="Label24" CssClass="lbl col-xs-4 col-sm-4 control-stock-label lang-location" runat="server" Text="Location"></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group" runat="server" id="divManufacturer">
                            <asp:Label ID="Label10" CssClass="lbl col-xs-4 col-sm-4 control-stock-label lang-manufacturer-brand" runat="server" Text="Manufacturer/Brand"></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblSup" CssClass="lbl col-xs-4 col-sm-4 control-stock-label lang-supplier-vendor" runat="server" Text="Supplier / Vendor <span class='required'>*</span>"></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group" id="divCostPrice" runat="server">
                            ...
                            <div class="col-xs-8 col-sm-8">
                                <div class="input-group">
                                    <asp:TextBox ID="txtBPrice" CssClass="form-control float-number-validate" runat="server" Text="" aria-describedby="btnBPriceEdit" OnTextChanged="unitTotalPurchaseAmt_click" AutoPostBack="True"></asp:TextBox>
                        ...
                        <div class="form-group" id="divCompanyPrice" runat="server">
                            <asp:Label ID="Label22" CssClass="lbl col-xs-4 col-sm-4 control-stock-label lang-set-company-price" runat="server" Text="Set Company Price "></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                                <div class="input-group">
                        ...
                        <div class="form-group" id="divSupplierCom" runat="server">
                            <asp:Label ID="lbl34" CssClass="lbl col-xs-4 col-sm-4 control-stock-label float-number-validate lang-supplier-commission" runat="server" Text="Supplier Commission"></asp:Label>
                            <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group">
                            <asp:Button ID="btnAdd" ValidationGroup="reqAddStock" CssClass="btn btn-info btn-sm CRBtnDesign btnResize e67e22 btnAddOpt" runat="server" Text="Add" OnClick="btnAdd_Click" />
                ...
                <div class="row import">
                    <div class="col-md-8">
                        <div class="form-inline data-import-box">
                            <h2 class="sectionHeading lang-import-products">Import New Products</h2>
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <div class="upload-section">
                                        ...
                                        <asp:Button ID="btnImportFile" ValidationGroup="import" runat="server" Text="Import File" CssClass="btn btn-info btn-sm CRBtnDesign btnResize e67e22 btn-import margin-write-20" OnClick="btnImportFile_Click" />
                                        <br />
                    ...
                    <div class="col-md-4">
                        <div class="form-inline data-import-box disNone">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="btnImportSample" runat="server" Text="Download Sample" CssClass="btn btn-info btn-sm CRBtnDesign" OnClick="btnImportSample_OnClick" />
                                </ContentTemplate>
                                <Triggers>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 form-horizontal" runat="server" id="divProductList">
                <div class="section">
                    <div class="row">
                        <div class="col-md-4">
                            <h2 class="sectionHeading lang-product-list">Product List </h2>
                        </div>

                    </div>

                    <div class="staticContentUnit mainItem">
                        <span runat="server" visible="false">SL</span>
                        <span class="lang-product-title">Product Title</span>
                        <span class="lang-price">Price</span>
                        <span class="lang-qty">Qty</span>
                        <span class="lang-total-price">Total Price</span>
                    </div>
                        ...
                        <div class="">
                            <div class="save-supply">
                                <div class="purchase-payment col-md-12">
                                    <div class="purchase-amount">
                                        <asp:Label ID="lblStockAmout" runat="server" CssClass="col-xs-4 col-md-5 padding-zero lang-total-purchase-amount" Text="Total Purchase Amount"></asp:Label>
                                    ...
                                    <div class="form-group">                                                                         
                                        <asp:Label ID="Label16" runat="server" CssClass="col-xs-4 col-md-5 lang-supplier-commission" Text="Supplier Commission"></asp:Label> <%--Text="Supplier Payment"--%>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                    ...
                                    <div class="form-group purchase-code">
                                        <asp:Label ID="Label4" runat="server" CssClass="col-xs-4 col-md-5 lang-purchase-code" Text="Purchase Code"></asp:Label>
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" ID="labelPurDate" CssClass="col-xs-4 col-md-5 lang-purchase-date" Text="Purchase Date"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                    ...
                                    <div class="form-group comment">
                                        <asp:Label ID="Label3" runat="server" CssClass="col-xs-4 col-md-5 lang-purchase-comment" Text="Purchase Comment"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                            <div class="">
                                                <asp:TextBox ID="txtComment" runat="server" CssClass="form-control width-purchase-adjustment" TextMode="MultiLine" placeholder="Write purchase notes" Columns="28"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="schedule-payment col-xs-12 col-md-12" runat="server" id="divSchedulePayment">
                                    <div class="disNone">
                                        <asp:CheckBox runat="server" ID="chkScheduePyament" CssClass="lang-schedule-payment" Text="Schedule Payment" />
                                    </div>

                                    <div class="form-group">
                                        <asp:Label ID="Label15" runat="server" CssClass="col-xs-4 col-md-5 lang-schedule-payment" Text="Schedule Payment"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="Label17" runat="server" CssClass="col-xs-4 col-md-5 lang-schedule-comment" Text="Schedule comment"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                            <div class="">
                                                <asp:TextBox ID="txtScheduleComment" runat="server" CssClass="form-control width-purchase-adjustment" TextMode="MultiLine" placeholder="Write purchase notes" Columns="28"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="supplier-received col-md-12" id="divSupplierReceived" runat="server">
                                    <div class="form-group">
                                        <asp:Label runat="server" ID="label18" CssClass="col-xs-4 col-md-5 total-received" Text="Track Received"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="Label19" runat="server" CssClass="col-xs-4 col-md-5 lang-track-received-comment" Text="Track Received Comment"></asp:Label>
                                        <div class="col-xs-8 col-md-7 bulk-stock">
                                            <asp:TextBox ID="txtSupplierReceivedComment" runat="server" CssClass="form-control width-purchase-adjustment" TextMode="MultiLine" placeholder="Write track received notes" Columns="28"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="multi-stock-button saveAll-cencel-btn">
                                    <asp:Button ID="btnSaveMultiStock" runat="server" Text="Save All" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnAddOpt stock-btn-saveAll" OnClick="btnSaveMultiStock_Click" />
                                    <asp:Button ID="btnCancelMultiStock" runat="server" Text="Cancel" CssClass="btn btn-info btn-sm CRBtnDesign btnResize btnReset" OnClick="btnCancelMultiStock_Click" />
                                </div>
                            </div>
                        </div>
