...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="section">
                <h2 class="sectionBreadcrumb"><%=Resources.Language.Title_smsConfig %></h2>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 form-horizontal" id="SmsConfig">
            ...
            <div class="ReturnfieldHeight2 section profile sms-config">
                ...
                <div class="form-group" id="selectUsername">
                    <div>
                        <label class="col-sm-2"><%=Resources.Language.Lbl_smsConfig_user_name %></label>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="form-group" id="selectPassword">
                    <div>
                        <label class="col-sm-2"><%=Resources.Language.Lbl_smsConfig_password %></label>
                    </div>
                    <div class="col-sm-8">
                 ...
                 <div class="form-group" id="selectApiKey">
                    <div>
                        <label class="col-sm-2"><%=Resources.Language.Lbl_smsConfig_api_key %></label>
                    </div>
                    <div class="col-sm-8">
                 ...
                 <div class="form-group" id="selectSenderKey">
                    <div>
                        <label class="col-sm-2"><%=Resources.Language.Lbl_smsConfig_sender_key %></label>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <button type="button" id="btnSaveChanges" class="btn btn-info btn-default btnSaveChangsCustom btnLimpCustom"><%=Resources.Language.Btn_smsConfig_save_changes %></button>
                    </div>
                    <div class="col-sm-2">
