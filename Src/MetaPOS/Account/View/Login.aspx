                ...
                <div class="row">
                    <div class="col l4 m12 s12 login_box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="company-signup">
                                            ...
                                            <a href="/signup" id="btnSignUp" runat="server" class="text-right">Try Amar Hishab for free</a></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row forgot_box">
                            <div class="container">
                                <div class="row signup">
                                    <h5>Hi, type your mail to recover</h5>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row">
                    ...
                    <div class="col l8 m12 s12 left-area">
                        <div class="left-content">
                            <div class="container content-index">
                                ...
                                <p class="content-desc">Amar Hishab offers you to manage your business in more comfortable way. We flow our slogan for 'Business Yours, Responsibility Ours'.</p>
